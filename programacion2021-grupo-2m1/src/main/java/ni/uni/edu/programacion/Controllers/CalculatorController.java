...
public class CalculatorController implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getActionCommand().equalsIgnoreCase("Calcular")){
            ...
            pnlCalculator.getTxtResult().setText(String.valueOf(operacion(n1,n2)));
    ...
    private double operacion(double a, double b){
        double operacion = 0;
        if (pnlCalculator.getjComboBox1().getSelectedItem().toString() == "Sumar") {
            operacion = a + b;
        } else if (pnlCalculator.getjComboBox1().getSelectedItem().toString() == "Restar") {
            operacion = a - b;
        } else if (pnlCalculator.getjComboBox1().getSelectedItem().toString() == "Multiplicar") {
            operacion = a * b;
        } else if (pnlCalculator.getjComboBox1().getSelectedItem().toString() == "Dividir") {
            operacion = a / b;
        }
        return operacion;
    }
